    ...
    <div className='flex flex-col md:grid md:grid-cols-2'>
      <div className='flex flex-col gap-3'>
        ...
        <div className='my-10 flex items-center gap-4 text-sm sm:text-base'>
          <button className='rounded-full bg-gradient-to-r from-blue-700 to-violet-700 text-white hover:opacity-70 px-4 py-2'>projects</button>
          <button className='rounded-full text-purple-800 border-solid border-violet-800 hover:opacity-70 px-4 py-2'>contact</button>
        </div>
      </div>
